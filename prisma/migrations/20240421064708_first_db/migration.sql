...
-- AddForeignKey
ALTER TABLE "RolePermissions" ADD CONSTRAINT "RolePermissions_rolId_fkey" FOREIGN KEY ("rolId") REFERENCES "Role"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RolePermissions" ADD CONSTRAINT "RolePermissions_modulePermissionId_fkey" FOREIGN KEY ("modulePermissionId") REFERENCES "ModulePermission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
